...
// Shared social button — also used by RegisterPage
export function SocialButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex h-10 items-center justify-center gap-2 rounded-xl border border-border/60 text-[13px] font-medium transition-all hover:bg-muted/50 active:scale-[0.99]"
    >
      {provider === 'google' ? (
